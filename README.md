...
**Terminal 1 (Server):**
```bash
./MT25067_PartA3_Server <message_size> <num_messages> <max_clients>
# Example: ./MT25067_PartA3_Server 1024 10000 4
```

**Terminal 2 (Client):**
```bash
./MT25067_PartA3_Client <message_size> <num_messages>
# Example: ./MT25067_PartA3_Client 1024 10000
```

**Note:** 
- Part A3 uses port 8082 (A1: 8080, A2: 8081)
- MSG_ZEROCOPY requires Linux kernel 4.14+ and may require privileges
- Check completion notifications and copy fallback statistics in server output
...
- ✅ Part A3: Zero-Copy implementation complete
